...
public class BoardCell {
	...
	public boolean isOpen() {
		return this.myCellType == CellType.OPEN || this.isSpam()||this.isPath();
	}
	...
	/** @return Is this cell a path to the nearest Spam? */
	public boolean isPath() {
		return this.myCellType == CellType.PATH;
	}
	...
	public Color getCellColor(){
		if (this.isWall()) {
			int cycleNum = SpampedeBrain.getCycleNum();
			// RAINBOW CODEEEEEEEEEEE
			return Color.getHSBColor((float) (.016*(cycleNum%60)), 0.4f , 0.75f);
			//return new Color(cycleNum%70+170, (cycleNum%255)%50+200, (cycleNum%150)%100+150);
		}
		else if (this.isPath()) {
			return Preferences.COLOR_PATH;
		} else if (this.isSpam()) {
	...
	/** Marks this cell as path cell */
	public void becomePath() {
		this.myCellType = CellType.PATH;
